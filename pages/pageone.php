		...
		<div class="container">
			<div class="intro row">
				<div class="columns small-12">
					...
					<a href="#" class="button button-secondary js_modal_trigger" data-mod-id="sample-video">modal video</a>
					<a href="#" class="button button-secondary js_modal_trigger" data-mod-id="sample-form">modal form</a>
